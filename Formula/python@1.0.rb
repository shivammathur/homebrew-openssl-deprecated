...
class PythonAT10 < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 arm64_big_sur: "7c89a483b72ba4d9e482f8371e0341ea99aa110fce1fe341b8146a034f69188f"
    sha256 catalina:      "78ea06ad8e25cd814691485aa61c990dca055aab0ba92532b482a023eb0be741"
  end
  ...
  depends_on "shivammathur/openssl-deprecated/tcl-tk@1.0"
  depends_on "sqlite"
  depends_on "xz"
  ...
  def install
    ...
    inreplace "./Lib/ctypes/macholib/dyld.py" do |f|
      f.gsub! "DEFAULT_LIBRARY_FALLBACK = [",
              "DEFAULT_LIBRARY_FALLBACK = [ '#{HOMEBREW_PREFIX}/lib', '#{Formula["openssl@1.0"].opt_lib}',"
